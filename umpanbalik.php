...
<p class="intro" style="color:#ff4d4d;">
  Terima kasih telah mengirimkan aspirasi Anda. Berikut adalah umpan balik dari pihak sekolah:
</p>
        ...
        <div class="feedback-card">
            ...
            <p><strong>Keterangan: </strong> <?= htmlspecialchars($r['ket']); ?></p>
